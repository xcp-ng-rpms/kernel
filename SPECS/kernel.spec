%global package_speccommit a2028a553c00ab31f1a97471044793fa9e0fc447
...
Patch285: 0001-Add-shadow-variables-support-from-kpatch.patch
Patch286: 0002-xen-xenbus-Allow-watches-discard-events-before-queue.patch
Patch287: 0003-xen-xenbus-Add-will_handle-callback-support-in-xenbu.patch
Patch288: 0004-xen-xenbus-xen_bus_type-Support-will_handle-watch-ca.patch
Patch289: 0005-xen-xenbus-Count-pending-messages-for-each-watch.patch
Patch290: 0006-xenbus-xenbus_backend-Disallow-pending-watch-message.patch
Patch291: kbuild-AFTER_LINK.patch
Patch292: expose-xsversion.patch
Patch293: blktap2.patch
Patch294: blkback-kthread-pid.patch
Patch295: tg3-alloc-repeat.patch
Patch296: disable-EFI-Properties-table-for-Xen.patch
Patch297: net-Do-not-scrub-ignore_df-within-the-same-name-spac.patch
Patch298: enable-fragmention-gre-packets.patch
Patch299: CA-285778-emulex-nic-ip-hdr-len.patch
Patch300: cifs-Change-the-default-value-SecFlags-to-0x83.patch
Patch301: call-kexec-before-offlining-noncrashing-cpus.patch
Patch302: hide-hung-task-for-idle-class.patch
Patch303: xfs-async-wait.patch
Patch304: 0002-scsi-libfc-drop-extra-rport-reference-in-fc_rport_cr.patch
Patch305: 0001-dma-add-dma_get_required_mask_from_max_pfn.patch
Patch306: 0002-x86-xen-correct-dma_get_required_mask-for-Xen-PV-gue.patch
Patch307: map-1MiB-1-1.patch
Patch308: hide-nr_cpus-warning.patch
Patch309: disable-pm-timer.patch
Patch310: increase-nr-irqs.patch
Patch311: xen-balloon-hotplug-select-HOLES_IN_ZONE.patch
...
Patch316: no-flr-quirk.patch
Patch317: revert-PCI-Probe-for-device-reset-support-during-enumeration.patch
Patch318: CA-135938-nfs-disconnect-on-rpc-retry.patch
Patch319: sunrpc-force-disconnect-on-connection-timeout.patch
Patch320: bonding-balance-slb.patch
Patch321: bridge-lock-fdb-after-garp.patch
Patch322: CP-13181-net-openvswitch-add-dropping-of-fip-and-lldp.patch
Patch323: xen-ioemu-inject-msi.patch
Patch324: pv-iommu-support.patch
Patch325: kexec-reserve-crashkernel-region.patch
Patch326: 0001-xen-swiotlb-rework-early-repeat-code.patch
Patch327: 0001-arch-x86-xen-add-infrastruction-in-xen-to-support-gv.patch
Patch328: 0002-drm-i915-gvt-write-guest-ppgtt-entry-for-xengt-suppo.patch
Patch329: 0003-drm-i915-xengt-xengt-moudule-initial-files.patch
Patch330: 0004-drm-i915-xengt-check-on_destroy-on-pfn_to_mfn.patch
Patch331: 0005-arch-x86-xen-Import-x4.9-interface-for-ioreq.patch
Patch332: 0006-i915-gvt-xengt.c-Use-new-dm_op-instead-of-hvm_op.patch
Patch333: 0007-i915-gvt-xengt.c-New-interface-to-write-protect-PPGT.patch
Patch334: 0008-i915-gvt-xengt.c-Select-vgpu-type-according-to-low_g.patch
Patch335: 0009-drm-i915-gvt-Don-t-output-error-message-when-DomU-ma.patch
Patch336: 0010-drm-i915-gvt-xengt-Correctly-get-low-mem-max-gfn.patch
Patch337: 0011-drm-i915-gvt-Fix-dom0-call-trace-at-shutdown-or-rebo.patch
Patch338: 0012-hvm-dm_op.h-Sync-dm_op-interface-to-xen-4.9-release.patch
Patch339: 0013-drm-i915-gvt-Apply-g2h-adjust-for-GTT-mmio-access.patch
Patch340: 0014-drm-i915-gvt-Apply-g2h-adjustment-during-fence-mmio-.patch
Patch341: 0015-drm-i915-gvt-Patch-the-gma-in-gpu-commands-during-co.patch
Patch342: 0016-drm-i915-gvt-Retrieve-the-guest-gm-base-address-from.patch
Patch343: 0017-drm-i915-gvt-Align-the-guest-gm-aperture-start-offse.patch
Patch344: 0018-drm-i915-gvt-Add-support-to-new-VFIO-subregion-VFIO_.patch
Patch345: 0019-drm-i915-gvt-Implement-vGPU-status-save-and-restore-.patch
Patch346: 0020-vfio-Implement-new-Ioctl-VFIO_IOMMU_GET_DIRTY_BITMAP.patch
Patch347: 0021-drm-i915-gvt-Add-dev-node-for-vGPU-state-save-restor.patch
Patch348: 0022-drm-i915-gvt-Add-interface-to-control-the-vGPU-runni.patch
Patch349: 0023-drm-i915-gvt-Modify-the-vGPU-save-restore-logic-for-.patch
Patch350: 0024-drm-i915-gvt-Add-log-dirty-support-for-XENGT-migrati.patch
Patch351: 0025-drm-i915-gvt-xengt-Add-iosrv_enabled-to-track-iosrv-.patch
Patch352: 0026-drm-i915-gvt-Add-xengt-ppgtt-write-handler.patch
Patch353: 0027-drm-i915-gvt-xengt-Impliment-mpt-dma_map-unmap_guest.patch
Patch354: 0028-drm-i915-gvt-introduce-a-new-VFIO-region-for-vfio-de.patch
Patch355: 0029-drm-i915-gvt-change-the-return-value-of-opregion-acc.patch
Patch356: 0030-drm-i915-gvt-Rebase-the-code-to-gvt-staging-for-live.patch
Patch357: 0031-drm-i915-gvt-Apply-g2h-adjustment-to-buffer-start-gm.patch
Patch358: 0032-drm-i915-gvt-Fix-xengt-opregion-handling-in-migratio.patch
Patch359: 0033-drm-i915-gvt-XenGT-migration-optimize.patch
Patch360: 0034-drm-i915-gvt-Add-vgpu-execlist-info-into-migration-d.patch
Patch361: 0035-drm-i915-gvt-Emulate-ring-mode-register-restore-for-.patch
Patch362: 0036-drm-i915-gvt-Use-copy_to_user-to-return-opregion.patch
Patch363: 0037-drm-i915-gvt-Expose-opregion-in-vgpu-open.patch
Patch364: 0038-drm-i915-gvt-xengt-Don-t-shutdown-vm-at-ioreq-failur.patch
Patch365: 0039-drm-i915-gvt-Emulate-hw-status-page-address-register.patch
Patch366: 0040-drm-i915-gvt-migration-copy-vregs-on-vreg-load.patch
Patch367: 0041-drm-i915-gvt-Fix-a-command-corruption-caused-by-live.patch
Patch368: 0042-drm-i915-gvt-update-force-to-nonpriv-register-whitel.patch
Patch369: 0043-drm-i915-gvt-xengt-Fix-xengt-instance-destroy-error.patch
Patch370: 0044-drm-i915-gvt-invalidate-old-ggtt-page-when-update-gg.patch
Patch371: 0045-drm-i915-gvt-support-inconsecutive-partial-gtt-entry.patch
Patch372: set-XENMEM_get_mfn_from_pfn-hypercall-number.patch
Patch373: gvt-enforce-primary-class-id.patch
Patch374: gvt-use-xs-vgpu-type.patch
Patch375: xengt-pviommu-basic.patch
Patch376: xengt-pviommu-unmap.patch
Patch377: get_domctl_interface_version.patch
Patch378: xengt-fix-shutdown-failures.patch
Patch379: xengt-i915-gem-vgtbuffer.patch
Patch380: xengt-gtt-2m-alignment.patch
Patch381: net-core__order-3_frag_allocator_causes_swiotlb_bouncing_under_xen.patch
Patch382: idle_cpu-return-0-during-softirq.patch
Patch383: default-xen-swiotlb-size-128MiB.patch
Patch384: dlm__increase_socket_backlog_to_avoid_hangs_with_16_nodes.patch
Patch385: gfs2-add-skippiness.patch
Patch386: GFS2__Avoid_recently_demoted_rgrps
Patch387: gfs2-debug-rgrp-sweep
Patch388: gfs2-restore-kabi.patch
Patch389: abi-version.patch
%if %{do_kabichk}
Source3: check-kabi
Source4: Module.kabi
%endif
