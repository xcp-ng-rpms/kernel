...
Patch363: xen-events-don-t-unmask-an-event-channel-when-an-eoi-is-pending.patch
Patch364: xen-events-avoid-handling-the-same-event-on-two-cpus-at-the-same-time.patch
Patch365: abi-version.patch
...
%changelog
* Wed Apr 07 2021 Ronan Abhamon <ronan.abhamon@vates.fr> - 4.19.19-7.0.11.2
- Remove blktap2.patch, it is no longer necessary since NBD is used instead
