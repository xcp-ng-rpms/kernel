...
Patch355: kbuild-AFTER_LINK.patch
Patch356: expose-xsversion.patch
Patch357: blktap2.patch
Patch358: blkback-kthread-pid.patch
Patch359: tg3-alloc-repeat.patch
Patch360: map-1MiB-1-1.patch
Patch361: disable-EFI-Properties-table-for-Xen.patch
Patch362: hide-nr_cpus-warning.patch
Patch363: disable-pm-timer.patch
Patch364: net-Do-not-scrub-ignore_df-within-the-same-name-spac.patch
Patch365: enable-fragmention-gre-packets.patch
Patch366: CA-285778-emulex-nic-ip-hdr-len.patch
Patch367: cifs-Change-the-default-value-SecFlags-to-0x83.patch
Patch368: call-kexec-before-offlining-noncrashing-cpus.patch
Patch369: hide-hung-task-for-idle-class.patch
Patch370: xfs-async-wait.patch
Patch371: 0002-scsi-libfc-drop-extra-rport-reference-in-fc_rport_cr.patch
Patch372: 0001-dma-add-dma_get_required_mask_from_max_pfn.patch
Patch373: 0002-x86-xen-correct-dma_get_required_mask-for-Xen-PV-gue.patch
Patch374: xen-balloon-hotplug-select-HOLES_IN_ZONE.patch
Patch375: mm-zero-last-section-tail.patch
Patch376: 0001-pci-export-pci_probe_reset_function.patch
Patch377: 0002-xen-pciback-provide-a-reset-sysfs-file-to-try-harder.patch
Patch378: pciback-disable-root-port-aer.patch
Patch379: pciback-mask-root-port-comp-timeout.patch
Patch380: no-flr-quirk.patch
Patch381: revert-PCI-Probe-for-device-reset-support-during-enumeration.patch
Patch382: CA-135938-nfs-disconnect-on-rpc-retry.patch
Patch383: sunrpc-force-disconnect-on-connection-timeout.patch
Patch384: nfs-avoid-double-timeout.patch
Patch385: bonding-balance-slb.patch
Patch386: bridge-lock-fdb-after-garp.patch
Patch387: CP-13181-net-openvswitch-add-dropping-of-fip-and-lldp.patch
Patch388: xen-ioemu-inject-msi.patch
Patch389: pv-iommu-support.patch
Patch390: kexec-reserve-crashkernel-region.patch
Patch391: 0001-xen-swiotlb-rework-early-repeat-code.patch
Patch392: 0001-arch-x86-xen-add-infrastruction-in-xen-to-support-gv.patch
Patch393: 0002-drm-i915-gvt-write-guest-ppgtt-entry-for-xengt-suppo.patch
Patch394: 0003-drm-i915-xengt-xengt-moudule-initial-files.patch
Patch395: 0004-drm-i915-xengt-check-on_destroy-on-pfn_to_mfn.patch
Patch396: 0005-arch-x86-xen-Import-x4.9-interface-for-ioreq.patch
Patch397: 0006-i915-gvt-xengt.c-Use-new-dm_op-instead-of-hvm_op.patch
Patch398: 0007-i915-gvt-xengt.c-New-interface-to-write-protect-PPGT.patch
Patch399: 0008-i915-gvt-xengt.c-Select-vgpu-type-according-to-low_g.patch
Patch400: 0009-drm-i915-gvt-Don-t-output-error-message-when-DomU-ma.patch
Patch401: 0010-drm-i915-gvt-xengt-Correctly-get-low-mem-max-gfn.patch
Patch402: 0011-drm-i915-gvt-Fix-dom0-call-trace-at-shutdown-or-rebo.patch
Patch403: 0012-hvm-dm_op.h-Sync-dm_op-interface-to-xen-4.9-release.patch
Patch404: 0013-drm-i915-gvt-Apply-g2h-adjust-for-GTT-mmio-access.patch
Patch405: 0014-drm-i915-gvt-Apply-g2h-adjustment-during-fence-mmio-.patch
Patch406: 0015-drm-i915-gvt-Patch-the-gma-in-gpu-commands-during-co.patch
Patch407: 0016-drm-i915-gvt-Retrieve-the-guest-gm-base-address-from.patch
Patch408: 0017-drm-i915-gvt-Align-the-guest-gm-aperture-start-offse.patch
Patch409: 0018-drm-i915-gvt-Add-support-to-new-VFIO-subregion-VFIO_.patch
Patch410: 0019-drm-i915-gvt-Implement-vGPU-status-save-and-restore-.patch
Patch411: 0020-vfio-Implement-new-Ioctl-VFIO_IOMMU_GET_DIRTY_BITMAP.patch
Patch412: 0021-drm-i915-gvt-Add-dev-node-for-vGPU-state-save-restor.patch
Patch413: 0022-drm-i915-gvt-Add-interface-to-control-the-vGPU-runni.patch
Patch414: 0023-drm-i915-gvt-Modify-the-vGPU-save-restore-logic-for-.patch
Patch415: 0024-drm-i915-gvt-Add-log-dirty-support-for-XENGT-migrati.patch
Patch416: 0025-drm-i915-gvt-xengt-Add-iosrv_enabled-to-track-iosrv-.patch
Patch417: 0026-drm-i915-gvt-Add-xengt-ppgtt-write-handler.patch
Patch418: 0027-drm-i915-gvt-xengt-Impliment-mpt-dma_map-unmap_guest.patch
Patch419: 0028-drm-i915-gvt-introduce-a-new-VFIO-region-for-vfio-de.patch
Patch420: 0029-drm-i915-gvt-change-the-return-value-of-opregion-acc.patch
Patch421: 0030-drm-i915-gvt-Rebase-the-code-to-gvt-staging-for-live.patch
Patch422: 0031-drm-i915-gvt-Apply-g2h-adjustment-to-buffer-start-gm.patch
Patch423: 0032-drm-i915-gvt-Fix-xengt-opregion-handling-in-migratio.patch
Patch424: 0033-drm-i915-gvt-XenGT-migration-optimize.patch
Patch425: 0034-drm-i915-gvt-Add-vgpu-execlist-info-into-migration-d.patch
Patch426: 0035-drm-i915-gvt-Emulate-ring-mode-register-restore-for-.patch
Patch427: 0036-drm-i915-gvt-Use-copy_to_user-to-return-opregion.patch
Patch428: 0037-drm-i915-gvt-Expose-opregion-in-vgpu-open.patch
Patch429: 0038-drm-i915-gvt-xengt-Don-t-shutdown-vm-at-ioreq-failur.patch
Patch430: 0039-drm-i915-gvt-Emulate-hw-status-page-address-register.patch
Patch431: 0040-drm-i915-gvt-migration-copy-vregs-on-vreg-load.patch
Patch432: 0041-drm-i915-gvt-Fix-a-command-corruption-caused-by-live.patch
Patch433: 0042-drm-i915-gvt-update-force-to-nonpriv-register-whitel.patch
Patch434: 0043-drm-i915-gvt-xengt-Fix-xengt-instance-destroy-error.patch
Patch435: 0044-drm-i915-gvt-invalidate-old-ggtt-page-when-update-gg.patch
Patch436: 0045-drm-i915-gvt-support-inconsecutive-partial-gtt-entry.patch
Patch437: set-XENMEM_get_mfn_from_pfn-hypercall-number.patch
Patch438: gvt-enforce-primary-class-id.patch
Patch439: gvt-use-xs-vgpu-type.patch
Patch440: xengt-pviommu-basic.patch
Patch441: xengt-pviommu-unmap.patch
Patch442: get_domctl_interface_version.patch
Patch443: xengt-fix-shutdown-failures.patch
Patch444: xengt-i915-gem-vgtbuffer.patch
Patch445: xengt-gtt-2m-alignment.patch
Patch446: net-core__order-3_frag_allocator_causes_swiotlb_bouncing_under_xen.patch
Patch447: idle_cpu-return-0-during-softirq.patch
Patch448: default-xen-swiotlb-size-128MiB.patch
Patch449: dlm__increase_socket_backlog_to_avoid_hangs_with_16_nodes.patch
Patch450: dlm_handle_uevent_erestartsys.patch
Patch451: gfs2-add-skippiness.patch
Patch452: GFS2__Avoid_recently_demoted_rgrps
Patch453: gfs2-debug-rgrp-sweep
Patch454: gfs2-restore-kabi.patch
Patch455: xsa331-linux.patch
Patch456: xsa332-linux-01.patch
Patch457: v11-0003-xen-events-fix-race-in-evtchn_fifo_unmask.patch
Patch458: xsa332-linux-02.patch
Patch459: xsa332-linux-03.patch
Patch460: xsa332-linux-04.patch
Patch461: xsa332-linux-05.patch
Patch462: xsa332-linux-06.patch
Patch463: xsa332-linux-07.patch
Patch464: xsa332-linux-08.patch
Patch465: xsa332-linux-09.patch
Patch466: xsa332-linux-10.patch
Patch467: xsa332-linux-11.patch
Patch468: 0001-Add-shadow-variables-support-from-kpatch.patch
Patch469: 0002-xen-xenbus-Allow-watches-discard-events-before-queue.patch
Patch470: 0003-xen-xenbus-Add-will_handle-callback-support-in-xenbu.patch
Patch471: 0004-xen-xenbus-xen_bus_type-Support-will_handle-watch-ca.patch
Patch472: 0005-xen-xenbus-Count-pending-messages-for-each-watch.patch
Patch473: 0006-xenbus-xenbus_backend-Disallow-pending-watch-message.patch
Patch474: xsa350-linux.patch
Patch475: xsa361-linux-1.patch
Patch476: xsa361-linux-2.patch
Patch477: xsa361-linux-3.patch
Patch478: xsa361-linux-4.patch
Patch479: xsa362-linux-1.patch
Patch480: xsa362-linux-2.patch
Patch481: xsa362-linux-3.patch
Patch482: 0001-xen-netback-avoid-race-in-xenvif_rx_ring_slots_avail.patch
Patch483: xsa365-linux.patch
Patch484: xsa371-linux.patch
Patch485: xsa367-linux.patch
Patch486: 0001-xen-netback-fix-spurious-event-detection-for-common-.patch
Patch487: 0007-xen-evtchn-use-smp-barriers-for-user-event-ring.patch
Patch488: 0008-xen-evtchn-use-READ-WRITE_ONCE-for-accessing-ring-in.patch
Patch489: xen-events-reset-affinity-of-2-level-event-when-tearing-it-down.patch
Patch490: xen-events-don-t-unmask-an-event-channel-when-an-eoi-is-pending.patch
Patch491: xen-events-avoid-handling-the-same-event-on-two-cpus-at-the-same-time.patch
Patch492: 0001-x86-ioperm-Add-new-paravirt-function-update_io_bitma.patch
Patch493: 0001-bpf-x86-Validate-computation-of-branch-displacements.patch
Patch494: 0002-bpf-x86-Validate-computation-of-branch-displacements.patch
Patch495: 0001-xen-events-fix-setting-irq-affinity.patch
Patch496: 0001-xen-events-reset-active-flag-for-lateeoi-events-late.patch
Patch497: 0001-seq_file-disallow-extremely-large-seq-buffer-allocat.patch
Patch498: 0001-xen-events-Fix-race-in-set_evtchn_to_irq.patch
Patch499: 0001-bpf-Do-not-use-ax-register-in-interpreter-on-div-mod.patch
Patch500: 0002-bpf-Fix-32-bit-src-register-truncation-on-div-mod.patch
Patch501: 0003-bpf-Fix-truncation-handling-for-mod32-dst-reg-wrt-ze.patch
Patch502: 0001-x86-timer-Skip-PIT-initialization-on-modern-chipsets.patch
Patch503: 0001-x86-timer-Force-PIT-initialization-when-X86_FEATURE_.patch
Patch504: 0001-x86-timer-Don-t-skip-PIT-setup-when-APIC-is-disabled.patch
Patch505: 0001-nbd-Fix-use-after-free-in-pid_show.patch
Patch506: 0001-xen-x86-obtain-upper-32-bits-of-video-frame-buffer-a.patch
Patch507: 0001-xen-x86-obtain-full-video-frame-buffer-address-for-D.patch
Patch508: xsa392-linux-1.patch
Patch509: xsa392-linux-2.patch
Patch510: 0001-xen-xenbus-Fix-granting-of-vmalloc-d-memory.patch
Patch511: 0001-xen-blkfront-switch-kcalloc-to-kvcalloc-for-large-ar.patch
Patch512: 0002-xen-blkfront-Adjust-indentation-in-xlvbd_alloc_gendi.patch
Patch513: 0003-xen-blkfront-fix-memory-allocation-flags-in-blkfront.patch
Patch514: 0004-xen-blkfront-allow-discard-nodes-to-be-optional.patch
Patch515: 0001-xen-sync-include-xen-interface-io-ring.h-with-Xen-s-.patch
Patch516: 0005-xen-blkfront-read-response-from-backend-only-once.patch
Patch517: 0006-xen-blkfront-don-t-take-local-copy-of-a-request-from.patch
Patch518: 0007-xen-blkfront-don-t-trust-the-backend-response-data-b.patch
Patch519: 0008-xen-blkfront-harden-blkfront-against-event-channel-s.patch
Patch520: 0001-xen-netfront-do-not-assume-sk_buff_head-list-is-empt.patch
Patch521: 0002-xen-netfront-do-not-use-0U-as-error-return-value-for.patch
Patch522: 0003-xen-netfront-fix-potential-deadlock-in-xennet_remove.patch
Patch523: 0004-xen-netfront-stop-tx-queues-during-live-migration.patch
Patch524: 0005-xen-netfront-read-response-from-backend-only-once.patch
Patch525: 0006-xen-netfront-don-t-read-data-from-request-on-the-rin.patch
Patch526: 0007-xen-netfront-disentangle-tx_skb_freelist.patch
Patch527: 0008-xen-netfront-don-t-trust-the-backend-response-data-b.patch
Patch528: 0009-xen-netfront-harden-netfront-against-event-channel-s.patch
Patch529: 0010-xen-netfront-destroy-queues-before-real_num_tx_queue.patch
Patch530: 0001-pvcalls-front-read-all-data-before-closing-the-conne.patch
Patch531: 0002-pvcalls-front-don-t-try-to-free-unallocated-rings.patch
Patch532: 0003-pvcalls-front-properly-allocate-sk.patch
Patch533: 0004-pvcalls-front-Avoid-get_free_pages-GFP_KERNEL-under-.patch
Patch534: 0005-pvcalls-front-fix-potential-null-dereference.patch
Patch535: 0006-xen-pvcalls-Remove-set-but-not-used-variable.patch
Patch536: 0007-pvcalls-front-don-t-return-error-when-the-ring-is-fu.patch
Patch537: 0001-xen-xenbus-don-t-let-xenbus_grant_ring-remove-grants.patch
Patch538: 0002-xen-grant-table-add-gnttab_try_end_foreign_access.patch
Patch539: 0003-xen-blkfront-don-t-use-gnttab_query_foreign_access-f.patch
Patch540: 0004-xen-netfront-don-t-use-gnttab_query_foreign_access-f.patch
Patch541: 0005-xen-scsifront-don-t-use-gnttab_query_foreign_access-.patch
Patch542: 0006-xen-gntalloc-don-t-use-gnttab_query_foreign_access.patch
Patch543: 0007-xen-remove-gnttab_query_foreign_access.patch
Patch544: 0008-xen-9p-use-alloc-free_pages_exact.patch
Patch545: 0009-xen-pvcalls-use-alloc-free_pages_exact.patch
Patch546: 0010-xen-gnttab-fix-gnttab_end_foreign_access-without-pag.patch
Patch547: 0011-xen-netfront-react-properly-to-failing-gnttab_end_fo.patch
Patch548: 0001-xen-blkfront-fix-leaking-data-in-shared-pages.patch
Patch549: 0002-xen-netfront-fix-leaking-data-in-shared-pages.patch
Patch550: 0003-xen-netfront-force-data-bouncing-when-backend-is-unt.patch
Patch551: 0004-xen-blkfront-force-data-bouncing-when-backend-is-unt.patch
Patch552: xsa423-linux.patch
Patch553: xsa424-linux.patch
Patch554: 0002-xen-netback-remove-unused-variables-pending_idx-and-.patch
Patch555: 0003-xen-netback-don-t-do-grant-copy-across-page-boundary.patch
Patch556: 0004-xen-netback-remove-not-needed-test-in-xenvif_tx_buil.patch
Patch557: 0005-xen-netback-use-same-error-messages-for-same-errors.patch
Patch558: xsa432-linux.patch
Patch559: xsa441-linux.patch
Patch560: abi-version.patch
%if %{do_kabichk}
Source3: check-kabi
Source4: Module.kabi
%endif
