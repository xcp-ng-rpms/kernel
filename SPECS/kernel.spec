%global package_speccommit ba5b7553764b912204d83efb720e63881c45798a
...
Patch443: 0001-nvme-fabrics-reject-I-O-to-offline-device.patch
Patch444: 0001-Add-shadow-variables-support-from-kpatch.patch
Patch445: 0002-xen-xenbus-Allow-watches-discard-events-before-queue.patch
Patch446: 0003-xen-xenbus-Add-will_handle-callback-support-in-xenbu.patch
Patch447: 0004-xen-xenbus-xen_bus_type-Support-will_handle-watch-ca.patch
Patch448: 0005-xen-xenbus-Count-pending-messages-for-each-watch.patch
Patch449: 0006-xenbus-xenbus_backend-Disallow-pending-watch-message.patch
Patch450: 0001-xen-xenbus-Fix-granting-of-vmalloc-d-memory.patch
Patch451: 0001-xen-blkfront-switch-kcalloc-to-kvcalloc-for-large-ar.patch
Patch452: 0002-xen-blkfront-Adjust-indentation-in-xlvbd_alloc_gendi.patch
Patch453: 0003-xen-blkfront-fix-memory-allocation-flags-in-blkfront.patch
Patch454: 0004-xen-blkfront-allow-discard-nodes-to-be-optional.patch
Patch455: 0001-xen-sync-include-xen-interface-io-ring.h-with-Xen-s-.patch
Patch456: 0005-xen-blkfront-read-response-from-backend-only-once.patch
Patch457: 0006-xen-blkfront-don-t-take-local-copy-of-a-request-from.patch
Patch458: 0007-xen-blkfront-don-t-trust-the-backend-response-data-b.patch
Patch459: 0008-xen-blkfront-harden-blkfront-against-event-channel-s.patch
Patch460: 0001-xen-netfront-do-not-assume-sk_buff_head-list-is-empt.patch
Patch461: 0002-xen-netfront-do-not-use-0U-as-error-return-value-for.patch
Patch462: 0003-xen-netfront-fix-potential-deadlock-in-xennet_remove.patch
Patch463: 0004-xen-netfront-stop-tx-queues-during-live-migration.patch
Patch464: 0005-xen-netfront-read-response-from-backend-only-once.patch
Patch465: 0006-xen-netfront-don-t-read-data-from-request-on-the-rin.patch
Patch466: 0007-xen-netfront-disentangle-tx_skb_freelist.patch
Patch467: 0008-xen-netfront-don-t-trust-the-backend-response-data-b.patch
Patch468: 0009-xen-netfront-harden-netfront-against-event-channel-s.patch
Patch469: 0010-xen-netfront-destroy-queues-before-real_num_tx_queue.patch
Patch470: 0001-pvcalls-front-read-all-data-before-closing-the-conne.patch
Patch471: 0002-pvcalls-front-don-t-try-to-free-unallocated-rings.patch
Patch472: 0003-pvcalls-front-properly-allocate-sk.patch
Patch473: 0004-pvcalls-front-Avoid-get_free_pages-GFP_KERNEL-under-.patch
Patch474: 0005-pvcalls-front-fix-potential-null-dereference.patch
Patch475: 0006-xen-pvcalls-Remove-set-but-not-used-variable.patch
Patch476: 0007-pvcalls-front-don-t-return-error-when-the-ring-is-fu.patch
Patch477: 0001-xen-xenbus-don-t-let-xenbus_grant_ring-remove-grants.patch
Patch478: 0002-xen-grant-table-add-gnttab_try_end_foreign_access.patch
Patch479: 0003-xen-blkfront-don-t-use-gnttab_query_foreign_access-f.patch
Patch480: 0004-xen-netfront-don-t-use-gnttab_query_foreign_access-f.patch
Patch481: 0005-xen-scsifront-don-t-use-gnttab_query_foreign_access-.patch
Patch482: 0006-xen-gntalloc-don-t-use-gnttab_query_foreign_access.patch
Patch483: 0007-xen-remove-gnttab_query_foreign_access.patch
Patch484: 0008-xen-9p-use-alloc-free_pages_exact.patch
Patch485: 0009-xen-pvcalls-use-alloc-free_pages_exact.patch
Patch486: 0010-xen-gnttab-fix-gnttab_end_foreign_access-without-pag.patch
Patch487: 0011-xen-netfront-react-properly-to-failing-gnttab_end_fo.patch
Patch488: 0001-xen-blkfront-fix-leaking-data-in-shared-pages.patch
Patch489: 0002-xen-netfront-fix-leaking-data-in-shared-pages.patch
Patch490: 0003-xen-netfront-force-data-bouncing-when-backend-is-unt.patch
Patch491: 0004-xen-blkfront-force-data-bouncing-when-backend-is-unt.patch
Patch492: xsa423-linux.patch
Patch493: xsa424-linux.patch
Patch494: 0002-xen-netback-remove-unused-variables-pending_idx-and-.patch
Patch495: 0003-xen-netback-don-t-do-grant-copy-across-page-boundary.patch
Patch496: 0004-xen-netback-remove-not-needed-test-in-xenvif_tx_buil.patch
Patch497: 0005-xen-netback-use-same-error-messages-for-same-errors.patch
Patch498: xsa432-linux.patch
Patch499: xsa441-linux.patch
Patch500: xsa448-linux.patch
Patch501: kbuild-AFTER_LINK.patch
Patch502: expose-xsversion.patch
Patch503: blktap2.patch
Patch504: blkback-kthread-pid.patch
Patch505: tg3-alloc-repeat.patch
Patch506: disable-EFI-Properties-table-for-Xen.patch
Patch507: net-Do-not-scrub-ignore_df-within-the-same-name-spac.patch
Patch508: enable-fragmention-gre-packets.patch
Patch509: CA-285778-emulex-nic-ip-hdr-len.patch
Patch510: cifs-Change-the-default-value-SecFlags-to-0x83.patch
Patch511: call-kexec-before-offlining-noncrashing-cpus.patch
Patch512: hide-hung-task-for-idle-class.patch
Patch513: xfs-async-wait.patch
Patch514: 0002-scsi-libfc-drop-extra-rport-reference-in-fc_rport_cr.patch
Patch515: dont-select-pinctrl.patch
Patch516: netscaler_everest_xs8_200g.patch
Patch517: 0001-dma-add-dma_get_required_mask_from_max_pfn.patch
Patch518: 0002-x86-xen-correct-dma_get_required_mask-for-Xen-PV-gue.patch
Patch519: map-1MiB-1-1.patch
Patch520: hide-nr_cpus-warning.patch
Patch521: disable-pm-timer.patch
Patch522: increase-nr-irqs.patch
Patch523: xen-balloon-hotplug-select-HOLES_IN_ZONE.patch
Patch524: 0001-pci-export-pci_probe_reset_function.patch
Patch525: 0002-xen-pciback-provide-a-reset-sysfs-file-to-try-harder.patch
Patch526: pciback-disable-root-port-aer.patch
Patch527: pciback-mask-root-port-comp-timeout.patch
Patch528: no-flr-quirk.patch
Patch529: revert-PCI-Probe-for-device-reset-support-during-enumeration.patch
Patch530: CA-135938-nfs-disconnect-on-rpc-retry.patch
Patch531: sunrpc-force-disconnect-on-connection-timeout.patch
Patch532: nfs-avoid-double-timeout.patch
Patch533: bonding-balance-slb.patch
Patch534: bridge-lock-fdb-after-garp.patch
Patch535: CP-13181-net-openvswitch-add-dropping-of-fip-and-lldp.patch
Patch536: xen-ioemu-inject-msi.patch
Patch537: pv-iommu-support.patch
Patch538: kexec-reserve-crashkernel-region.patch
Patch539: 0001-xen-swiotlb-rework-early-repeat-code.patch
Patch540: 0001-arch-x86-xen-add-infrastruction-in-xen-to-support-gv.patch
Patch541: 0002-drm-i915-gvt-write-guest-ppgtt-entry-for-xengt-suppo.patch
Patch542: 0003-drm-i915-xengt-xengt-moudule-initial-files.patch
Patch543: 0004-drm-i915-xengt-check-on_destroy-on-pfn_to_mfn.patch
Patch544: 0005-arch-x86-xen-Import-x4.9-interface-for-ioreq.patch
Patch545: 0006-i915-gvt-xengt.c-Use-new-dm_op-instead-of-hvm_op.patch
Patch546: 0007-i915-gvt-xengt.c-New-interface-to-write-protect-PPGT.patch
Patch547: 0008-i915-gvt-xengt.c-Select-vgpu-type-according-to-low_g.patch
Patch548: 0009-drm-i915-gvt-Don-t-output-error-message-when-DomU-ma.patch
Patch549: 0010-drm-i915-gvt-xengt-Correctly-get-low-mem-max-gfn.patch
Patch550: 0011-drm-i915-gvt-Fix-dom0-call-trace-at-shutdown-or-rebo.patch
Patch551: 0012-hvm-dm_op.h-Sync-dm_op-interface-to-xen-4.9-release.patch
Patch552: 0013-drm-i915-gvt-Apply-g2h-adjust-for-GTT-mmio-access.patch
Patch553: 0014-drm-i915-gvt-Apply-g2h-adjustment-during-fence-mmio-.patch
Patch554: 0015-drm-i915-gvt-Patch-the-gma-in-gpu-commands-during-co.patch
Patch555: 0016-drm-i915-gvt-Retrieve-the-guest-gm-base-address-from.patch
Patch556: 0017-drm-i915-gvt-Align-the-guest-gm-aperture-start-offse.patch
Patch557: 0018-drm-i915-gvt-Add-support-to-new-VFIO-subregion-VFIO_.patch
Patch558: 0019-drm-i915-gvt-Implement-vGPU-status-save-and-restore-.patch
Patch559: 0020-vfio-Implement-new-Ioctl-VFIO_IOMMU_GET_DIRTY_BITMAP.patch
Patch560: 0021-drm-i915-gvt-Add-dev-node-for-vGPU-state-save-restor.patch
Patch561: 0022-drm-i915-gvt-Add-interface-to-control-the-vGPU-runni.patch
Patch562: 0023-drm-i915-gvt-Modify-the-vGPU-save-restore-logic-for-.patch
Patch563: 0024-drm-i915-gvt-Add-log-dirty-support-for-XENGT-migrati.patch
Patch564: 0025-drm-i915-gvt-xengt-Add-iosrv_enabled-to-track-iosrv-.patch
Patch565: 0026-drm-i915-gvt-Add-xengt-ppgtt-write-handler.patch
Patch566: 0027-drm-i915-gvt-xengt-Impliment-mpt-dma_map-unmap_guest.patch
Patch567: 0028-drm-i915-gvt-introduce-a-new-VFIO-region-for-vfio-de.patch
Patch568: 0029-drm-i915-gvt-change-the-return-value-of-opregion-acc.patch
Patch569: 0030-drm-i915-gvt-Rebase-the-code-to-gvt-staging-for-live.patch
Patch570: 0031-drm-i915-gvt-Apply-g2h-adjustment-to-buffer-start-gm.patch
Patch571: 0032-drm-i915-gvt-Fix-xengt-opregion-handling-in-migratio.patch
Patch572: 0033-drm-i915-gvt-XenGT-migration-optimize.patch
Patch573: 0034-drm-i915-gvt-Add-vgpu-execlist-info-into-migration-d.patch
Patch574: 0035-drm-i915-gvt-Emulate-ring-mode-register-restore-for-.patch
Patch575: 0036-drm-i915-gvt-Use-copy_to_user-to-return-opregion.patch
Patch576: 0037-drm-i915-gvt-Expose-opregion-in-vgpu-open.patch
Patch577: 0038-drm-i915-gvt-xengt-Don-t-shutdown-vm-at-ioreq-failur.patch
Patch578: 0039-drm-i915-gvt-Emulate-hw-status-page-address-register.patch
Patch579: 0040-drm-i915-gvt-migration-copy-vregs-on-vreg-load.patch
Patch580: 0041-drm-i915-gvt-Fix-a-command-corruption-caused-by-live.patch
Patch581: 0042-drm-i915-gvt-update-force-to-nonpriv-register-whitel.patch
Patch582: 0043-drm-i915-gvt-xengt-Fix-xengt-instance-destroy-error.patch
Patch583: 0044-drm-i915-gvt-invalidate-old-ggtt-page-when-update-gg.patch
Patch584: 0045-drm-i915-gvt-support-inconsecutive-partial-gtt-entry.patch
Patch585: set-XENMEM_get_mfn_from_pfn-hypercall-number.patch
Patch586: gvt-enforce-primary-class-id.patch
Patch587: gvt-use-xs-vgpu-type.patch
Patch588: xengt-pviommu-basic.patch
Patch589: xengt-pviommu-unmap.patch
Patch590: get_domctl_interface_version.patch
Patch591: xengt-fix-shutdown-failures.patch
Patch592: xengt-i915-gem-vgtbuffer.patch
Patch593: xengt-gtt-2m-alignment.patch
Patch594: net-core__order-3_frag_allocator_causes_swiotlb_bouncing_under_xen.patch
Patch595: idle_cpu-return-0-during-softirq.patch
Patch596: default-xen-swiotlb-size-128MiB.patch
Patch597: dlm__increase_socket_backlog_to_avoid_hangs_with_16_nodes.patch
Patch598: gfs2-add-skippiness.patch
Patch599: GFS2__Avoid_recently_demoted_rgrps
Patch600: gfs2-debug-rgrp-sweep
Patch601: gfs2-restore-kabi.patch
Patch602: 0001-Add-auxiliary-bus-support.patch
Patch603: 0002-driver-core-auxiliary-bus-move-slab.h-from-include-f.patch
Patch604: 0003-driver-core-auxiliary-bus-make-remove-function-retur.patch
Patch605: 0004-driver-core-auxiliary-bus-minor-coding-style-tweaks.patch
Patch606: 0005-driver-core-auxiliary-bus-Fix-auxiliary-bus-shutdown.patch
Patch607: 0006-driver-core-auxiliary-bus-Fix-calling-stage-for-auxi.patch
Patch608: 0007-driver-core-auxiliary-bus-Remove-unneeded-module-bit.patch
Patch609: 0008-driver-core-auxiliary-bus-Fix-memory-leak-when-drive.patch
Patch610: 0009-Documentation-auxiliary_bus-Clarify-auxiliary_device.patch
Patch611: 0010-Documentation-auxiliary_bus-Clarify-__auxiliary_driv.patch
Patch612: 0011-Documentation-auxiliary_bus-Clarify-the-release-of-d.patch
Patch613: 0012-Documentation-auxiliary_bus-Move-the-text-into-the-c.patch
Patch614: 0013-CP-41018-Make-CONFIG_AUXILIARY_BUS-y-work.patch
Patch615: scsi-avoid-lun-change-loop.patch
Patch616: abi-version.patch
%if %{do_kabichk}
Source3: check-kabi
Source4: Module.kabi
%endif
