...
%define pkgrelease 0.rc5.23
%define kversion 6
%define tarfile_release 6.11.0-0.rc5.23.el10
# This is needed to do merge window version magic
%define patchlevel 11
# This allows pkg_release to have configurable %%{?dist} tag
%define specrelease 0.rc5.23%{?buildid}%{?dist}
# This defines the kabi tarball version
%define kabiversion 6.11.0-0.rc5.23.el10
...
#
%changelog
* Mon Sep 23 2024 Jan Stancek <jstancek@redhat.com> [6.11.0-0.rc5.23.el10]
- redhat: change dist-git branch to 10.0-beta (Jan Stancek)
- Revert "KVM: VMX: Always honor guest PAT on CPUs that support self-snoop" (Vitaly Kuznetsov) [RHEL-54353]
- uki-virt: add systemd-cryptsetup module (Vitaly Kuznetsov) [RHEL-57723]
